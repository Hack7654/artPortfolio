...
var SceneContext = class extends Context {
  ...
  _applyShadow(shape) {
    var _a2, _b2, _c;
    var color = (_a2 = shape.getShadowRGBA()) !== null && _a2 !== void 0 ? _a2 : "black", blur = (_b2 = shape.getShadowBlur()) !== null && _b2 !== void 0 ? _b2 : 5, offset = (_c = shape.getShadowOffset()) !== null && _c !== void 0 ? _c : {
      x: 0,
      y: 0
...
var Node = class _Node {
  ...
  _getTransform() {
    ...
    m.reset();
    var x = this.x(), y = this.y(), rotation = Konva.getAngle(this.rotation()), scaleX = (_a2 = this.attrs.scaleX) !== null && _a2 !== void 0 ? _a2 : 1, scaleY = (_b2 = this.attrs.scaleY) !== null && _b2 !== void 0 ? _b2 : 1, skewX = this.attrs.skewX || 0, skewY = this.attrs.skewY || 0, offsetX = this.attrs.offsetX || 0, offsetY = this.attrs.offsetY || 0;
    if (x !== 0 || y !== 0) {
      m.translate(x, y);
    }
    if (rotation !== 0) {
